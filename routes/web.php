...
//    Route::post('forgot-password/{userId}/{passwordResetCode}', 'AuthController@getForgotPasswordConfirm');
    ...
    # Logout
    Route::get('admin/logout', 'AuthController@getLogout')->name('logout');
...
// Route::get('/', 'JoshController@showHome')->name('admin.dashboard');
Route::get('dashboard', 'JoshController@showHome')->name('admin.dashboard');
